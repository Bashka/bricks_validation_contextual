...
Пакет реализует механизм контекстной валидации объектов.
...
[исходные коды]: https://github.com/Bashka/bricks_validation_contextual/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_validation_contextual/issues
